...
`cnpg-headlamp-plugin` is a component of the **Community, Docs & Ecosystem** subproject of
...
repository through the `cnpg-headlamp-plugin-owners` GitHub team, and are its default
[`CODEOWNERS`](CODEOWNERS) entry, so every pull request here is routed to
them for review.

| Name | GitHub Handle | Country |
| :--- | :--- | :--- |
| Tamara Nocentini | [@TamaraNocentini](https://github.com/TamaraNocentini) | Italy |
